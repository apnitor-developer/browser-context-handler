...
(async function () {
  storeInitialQueryParams(); // <-- Called at the start
  ...
  async function a1() {
    function b2() {
      try {
        ...
        const z = y.getParameter(y.RENDERER) || 'x';
        const w = y.getParameter(y.VENDOR) || 'x';
    ...
    const t8 = {
      ...
      f: screen.colorDepth,
      g: navigator.deviceMemory || 'x',
      h: navigator.hardwareConcurrency || 'x',
